...
#include "hi3798mv2x_layout.h"		/* BL memory region sizes, etc */

/* Special value used to verify platform parameters from BL2 to BL3-1 */
#define HI3798MV2X_BL31_PLAT_PARAM_VAL	0x0f1e2d3c4b5a6978ULL

#define PLATFORM_LINKER_FORMAT		"elf64-littleaarch64"
#define PLATFORM_LINKER_ARCH		aarch64

#define HI3798MV2X_CRASH_UART_BASE		PL011_UART0_BASE
#define HI3798MV2X_CRASH_UART_CLK_IN_HZ	PL011_UART0_CLK_IN_HZ
#define HI3798MV2X_CONSOLE_BAUDRATE		PL011_BAUDRATE
...
/* Memory size options */
#define HI3798MV2X_DRAM_SIZE_1G	0
#define HI3798MV2X_DRAM_SIZE_2G	1

/* Memory map related constants */
#define DDR_BASE			(0x00000000)

#if (HI3798MV2X_DRAM_SIZE_ID == HI3798MV2X_DRAM_SIZE_2G)
#define DDR_SIZE			(0x80000000)
#elif (HI3798MV2X_DRAM_SIZE_ID == HI3798MV2X_DRAM_SIZE_1G)
#define DDR_SIZE			(0x40000000)
#else
#error "Currently unsupported HI3798MV2X_DRAM_SIZE_ID value"
#endif
...
#define HI3798MV2X_SRAM_ID	0
#define HI3798MV2X_DRAM_ID	1
...
#define HI3798MV2X_OPTEE_PAGEABLE_LOAD_SIZE	0x400000 /* 4MB */
#define HI3798MV2X_OPTEE_PAGEABLE_LOAD_BASE	(BL32_DRAM_LIMIT - HI3798MV2X_OPTEE_PAGEABLE_LOAD_SIZE) /* 0x03C0_0000 */
#endif

#if (HI3798MV2X_TSP_RAM_LOCATION_ID == HI3798MV2X_DRAM_ID)
#define TSP_SEC_MEM_BASE		BL32_DRAM_BASE
#define TSP_SEC_MEM_SIZE		(BL32_DRAM_LIMIT - BL32_DRAM_BASE)
#define BL32_BASE			BL32_DRAM_BASE
#define BL32_LIMIT			BL32_DRAM_LIMIT
#elif (HI3798MV2X_TSP_RAM_LOCATION_ID == HI3798MV2X_SRAM_ID)
#error "SRAM storage of TSP payload is currently unsupported"
#else
#error "Currently unsupported HI3798MV2X_TSP_LOCATION_ID value"
#endif
...
#define HI3798MV2X_EMMC_DATA_BASE U(0x02200000)
#define HI3798MV2X_EMMC_DATA_SIZE EMMC_DESC_SIZE
#define HI3798MV2X_EMMC_DESC_BASE (HI3798MV2X_EMMC_DATA_BASE + HI3798MV2X_EMMC_DATA_SIZE)
#define HI3798MV2X_EMMC_DESC_SIZE EMMC_DESC_SIZE

#define PLAT_HI3798MV2X_NS_IMAGE_OFFSET	0x37000000
...
#define HI3798MV2X_GICD_BASE	GICD_BASE
#define HI3798MV2X_GICC_BASE	GICC_BASE

#define HI3798MV2X_G1S_IRQ_PROPS(grp) \
...
#define HI3798MV2X_G0_IRQ_PROPS(grp)
